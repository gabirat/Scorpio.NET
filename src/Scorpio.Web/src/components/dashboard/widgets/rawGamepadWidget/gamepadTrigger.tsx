...
export default function GamepadTrigger(props: IGamepadTriggerProps) {
  return (
    <svg viewBox="-1.2 -2.2 1.4 4.4" width="50" height="100">
      <rect x="-0.5" y="-2.0" width="1" height="4" fill="red" stroke="#888" strokeWidth="0.04" />
      <rect x="-0.5" y="-2.0" width="1" height={4 - props.value * 4} fill="white" stroke="#red" strokeWidth="0.04" />
